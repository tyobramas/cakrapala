...
const MODULES: ModuleCard[] = [
  ...
  {
    id: "mission-control",
    mfdCode: "MODULE 06 // AI MISSION CONTROL",
    title: "AI Mission Control",
    subtitle: "PHYSICS-BASED MISSION PLANNING",
    description: "AI-assisted mission planning workspace with physics-based satellite launch orbit planner, lunar free-return trajectory explorer, Lambert solver, Tsiolkovsky delta-v analysis, and deterministic risk assessment.",
    ...
    features: [
      "Satellite Launch Orbit Feasibility Analysis",
      "Time-Aware Lunar Transfer Search (Lambert)",
      "Patched-Conic Free-Return Screening",
      "AI Copilot Mission Brief Interpreter",
    ],
  },
];
